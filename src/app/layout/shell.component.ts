...
export class ShellComponent {
  ...
  /**
   * Performance: Memoize navigation items to prevent redundant service calls
   * and array allocations during Angular change detection cycles.
   */
  ...
  /**
   * Performance: Optimization for *ngFor to track items by route instead of reference.
   */
