...
export class ShellComponent {
  ...
  /**
   * Optimized navigation items observable that only recalculates when the user role changes.
   * This prevents redundant service calls and template re-evaluations during change detection.
   */
