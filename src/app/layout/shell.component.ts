...
export class ShellComponent {
  ...
  // Performance: Memoize navigation items based on the user's role to avoid
  // re-calculating them on every change detection cycle.
  readonly navItems$: Observable<NavItem[]> = this.auth.user$.pipe(
    map((user) => user?.role),
