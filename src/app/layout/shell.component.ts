...
export class ShellComponent {
   ...
   * Prevents redundant calls to NavigationService.navItems in the template.
   */
  ...
  /**
   * trackBy function for the navigation list to optimize DOM re-rendering.
   */
  trackByNavRoute(index: number, item: NavItem): string {
    return item.route;
  }
