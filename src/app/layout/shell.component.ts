...
export class ShellComponent {
  ...
  // ⚡ Optimization: Memoize navigation items to prevent redundant calculations on setiap change detection cycle
  ...
  // ⚡ Optimization: trackBy for better *ngFor performance
