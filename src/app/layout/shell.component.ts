...
export class ShellComponent {
  ...
  /**
   * Performance: Memoize navigation items based on user role to avoid
   * redundant calculations on every change detection cycle.
   */
  ...
  /**
   * Performance: trackBy function for navItems loop to minimize DOM re-renders.
   */
